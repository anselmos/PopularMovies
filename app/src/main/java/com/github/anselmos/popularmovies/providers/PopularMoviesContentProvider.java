package com.github.anselmos.popularmovies.providers;
...
/**
 * Created by anselmos on 05.05.17.
 */
public class PopularMoviesContentProvider extends ContentProvider {
    
    static final String PROVIDER_NAME = "com.github.anselmos.popularmovies";
    ...
    static final String DATABASE_NAME = "MoviesFavourites";
    ...
    public Cursor query(Uri uri, String[] projection,
        ...
        if (sortOrder == null || sortOrder == ""){
            /**
             * By default sort on movies names
             */
